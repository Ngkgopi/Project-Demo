                ...
                <div data-aos='fade-up' data-aos-delay='500' className='flex flex-wrap -m-4 text-center'>
                    <div className='p-4 md:w-1/4 sm:w-1/2 w-full'>
                     <div className='border-2 border-blue-200 px-4 py-6 rounded-lg'>
                        <h2 className='title-font font-medium text-3xl text-gray-900'>1y</h2>
                        <p className='leading-relaxed'>experience</p>
                     </div>
                    </div>
                    <div className='p-4 md:w-1/4 sm:w-1/2 w-full'>
                     <div className='border-2 border-blue-200 px-4 py-6 rounded-lg'>
                        <h2 className='title-font font-medium text-3xl text-gray-900'>+10 assignment</h2>
                        <p className='leading-relaxed'>Project</p>
                     </div>
                    </div>
                    <div className='p-4 md:w-1/4 sm:w-1/2 w-full'>
                     <div className='border-2 border-blue-200 px-4 py-6 rounded-lg'>
                        <h2 className='title-font font-medium text-3xl text-gray-900'>3 major project</h2>
                        <p className='leading-relaxed'>Innomatics Research labs </p>
                     </div>
                    </div>
